...
*(Both generated by your own `metrics.yml` workflow below — no third-party server, so nothing 503s on you.)*
...
*(Set up the `snake.yml` workflow below to make this render — see setup notes.)*
